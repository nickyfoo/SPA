...
std::vector<std::string> *PQLQuery::get_query_entities() { return this->entities_; }

std::vector<SuchThatClause *> *PQLQuery::get_query_relationships() { return this->relationships_; }

std::vector<PatternClause *> *PQLQuery::get_query_patterns() { return this->patterns_; }
